      ...
      <SectionWrapper background="cta" ariaLabel="Partnerships and booking">
        <div className="max-w-2xl mx-auto text-center">
          <AnimatedReveal>
            ...
            <Link
              to="/booking"
              className="inline-flex items-center justify-center gap-2 min-h-[48px] px-6 py-3 rounded-xl font-semibold text-navy-900 bg-[#ffe600] hover:bg-[#ffec33] transition-colors"
            >
              Inquire or book
